 ...
 */
#ifdef PACT_SIM
    #define LV_USE_STDLIB_MALLOC    LV_STDLIB_CLIB  /* host: real malloc, no pool limit */
#else
...
#ifdef PACT_SIM
#define LV_USE_FS_FATFS 0   /* host uses FS_STDIO; device art paths ("A:1:/...") go through FatFs */
#else
