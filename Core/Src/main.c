...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PLL2.PLL2N = 361;
  PeriphClkInitStruct.PLL2.PLL2P = 32;
  PeriphClkInitStruct.PLL2.PLL2Q = 2;
  PeriphClkInitStruct.PLL2.PLL2R = 2;
  PeriphClkInitStruct.PLL2.PLL2RGE = RCC_PLL2VCIRANGE_0;
  PeriphClkInitStruct.PLL2.PLL2VCOSEL = RCC_PLL2VCOWIDE;
  PeriphClkInitStruct.PLL2.PLL2FRACN = 2189;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, AMP_EN_Pin|USB_PHY_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PWR_HOLD_GPIO_Port, PWR_HOLD_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, EMMC_RST_Pin|PMIC_EN_Pin|PMIC_CTRL_Pin|DISP_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DAC_XSMT_Pin PWR_HOLD_Pin */
  GPIO_InitStruct.Pin = DAC_XSMT_Pin|PWR_HOLD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : PWR5V_EN_Pin */
  GPIO_InitStruct.Pin = PWR5V_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PWR5V_EN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : AMP_EN_Pin USB_PHY_RST_Pin */
  GPIO_InitStruct.Pin = AMP_EN_Pin|USB_PHY_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : BTN_PLAY_Pin */
  GPIO_InitStruct.Pin = BTN_PLAY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BTN_PLAY_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : PG_STAT_Pin */
  GPIO_InitStruct.Pin = PG_STAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(PG_STAT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : JACK_DET_Pin SD_CD_Pin */
  GPIO_InitStruct.Pin = JACK_DET_Pin|SD_CD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : BTN_NEXT_Pin BTN_PREV_Pin BTN_MENU_Pin VOL_UP_Pin
                           VOL_DOWN_Pin BTN_FN_Pin */
  GPIO_InitStruct.Pin = BTN_NEXT_Pin|BTN_PREV_Pin|BTN_MENU_Pin|VOL_UP_Pin
                          |VOL_DOWN_Pin|BTN_FN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : EMMC_RST_Pin PMIC_EN_Pin PMIC_CTRL_Pin DISP_RST_Pin */
  GPIO_InitStruct.Pin = EMMC_RST_Pin|PMIC_EN_Pin|PMIC_CTRL_Pin|DISP_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pin : PWR_SW_SENSE_Pin */
  GPIO_InitStruct.Pin = PWR_SW_SENSE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PWR_SW_SENSE_GPIO_Port, &GPIO_InitStruct);

  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(PWR_SW_SENSE_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(PWR_SW_SENSE_EXTI_IRQn);

  HAL_NVIC_SetPriority(JACK_DET_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(JACK_DET_EXTI_IRQn);

  HAL_NVIC_SetPriority(BTN_MENU_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(BTN_MENU_EXTI_IRQn);
